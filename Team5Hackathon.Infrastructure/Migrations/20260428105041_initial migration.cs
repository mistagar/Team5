        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedById = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("582880c3-f554-490f-a24e-526db35cffa5"), null, "Supervisor with supervisory permissions", "Supervisor", "SUPERVISOR" },
                    { new Guid("a3d7f9b1-8c42-4e6d-b5a9-91c2e7f4d8ab"), null, "Customer with Customer access", "Customer", "CUSTOMER" },
                    { new Guid("c4a3298c-6198-4d12-bd1a-56d1d1ce0aa7"), null, "Administrator with full permissions", "Admin", "ADMIN" },
                    { new Guid("e8b9c5d2-3f1a-4b7e-9d6c-2a8f7e5b4c3d"), null, "Agent with agent permissions", "Agent", "AGENT" }
                });
